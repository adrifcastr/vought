...
export async function run(message, args) {
    ...
    try {
        ...
        if (body.status === 404) return message.channel.send(Util.Embed('There was no data for this episode!', null));
        ...
        message.channel.send(Util.Embed('An error occurred while trying to fetch the episodes!', null));
    }
}
export const help = {
    name: ['ep', 'episode'],
