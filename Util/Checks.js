...
class Checks {
    ...
    static async CSD(message, Util) {
        ...
        else if (message.content.match(/(?:begone)/i) && message.content.match(/(?:thot)/i)) message.channel.send(Util.Embed(message.member).setImage('https://cdn.discordapp.com/attachments/608796284488515588/768901541011783680/image0.jpg'));
